...
public class ProxyIp implements Serializable {
	...
	public String toString() {
		return "ProxyIp [id=" + id + ", proxyIp=" + proxyIp + ", proxyPort=" + proxyPort + ", anonymity=" + anonymity
				+ ", proxyType=" + proxyType + ", ipAddress=" + ipAddress + ", responseSpeed=" + responseSpeed
				+ ", aliveTime=" + aliveTime + ", insertTime=" + insertTime + ", updateTime=" + updateTime + "]";
	}
